...
export default function ModernPostCard({
    ...
    const handleEdit = (e) => {
        ...
        if (onEdit) {
            ...
            // 기본 수정 기능
            window.open(
                `/${gameType}/community/post/${post.id}/edit`,
                "_blank"
            );
        }
    };
                            ...
                            <div className="w-10 h-10 bg-gray-100 dark:bg-dark-700 rounded-lg flex items-center justify-center">
                                ...
                                >
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                        strokeWidth={2}
                                        d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h.01M15 14h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
                                    />
                                </svg>
                            </div>
                        )}
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div
                            className={`flex items-center space-x-1 ${
                                gameType === "lol" ? "bg-blue-50" : "bg-red-50"
