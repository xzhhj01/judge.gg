...
export default function FixedWidthPostCard({ post, gameType = "lol" }) {
    ...
    return (
        <Link href={`/${gameType}/community/post/${post.id}`}>
            <div className="w-[360px] bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
                <div className="p-4">
                    {/* 제목과 마감일 */}
